...
class ref : private linked_ref
{
  public:
    ...
    {
        // No self assignemnt is possible, because of the different type parameter

        linked_ref::operator=(other);
    ...
    ref &operator=(ref<TOther> &&other) noexcept
    {
        ...
        linked_ref::operator=(std::move(other));
    ...
    ref<TOther> static_down_cast() const
    {
        ...
        return ref<TOther>(static_cast<TOther&>(*instance_), *reference_chain_);
    }
    ...
    {
        // This is an explicit operation, so it is safe to cast
        return ref<TOther>(dynamic_cast<TOther&>(*instance_), *reference_chain_);
    }
  ...
  private:
    ...
    ref(T &instance, reference_chain &link_container)
        : linked_ref(&link_container)
        , instance_(&instance)
    {
    }
