...
TEST(counted_casting_test, explicit_upcasting_construction_from_var)
{
...
TEST(counted_casting_test, implicit_upcasting_construction_from_var)
{
    saam::var<derived> derived_instance;
...
TEST(counted_casting_test, upcasting_construction_from_ref)
{
    saam::var<derived> derived_instance;
...
TEST(counted_casting_test, upcasting_assignment_from_var)
{
    saam::var<derived> derived_instance;
...
TEST(counted_casting_test, upcasting_assignment_from_ref)
{
    saam::var<derived> derived_instance;
...
TEST(counted_casting_test, static_downcasting_from_ref)
{
    saam::var<derived> derived_instance;
...
TEST(counted_casting_test, dynamic_downcasting_from_ref)
{
    saam::var<derived> derived_instance;
