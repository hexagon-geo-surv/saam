...
TEST(counted_var_test, var_underlying_type_copy_creation)
{
...
TEST(counted_var_test, var_underlying_type_move_creation)
{
    std::string text("Hello world");
...
TEST(counted_var_test, var_emplace_creation)
{
    saam::var<std::string> text(std::in_place, "Hello world");
    ASSERT_EQ(text->length(), 11);
}

TEST(counted_var_test, var_underlying_type_copy_assignment)
{
...
TEST(counted_var_test, var_underlying_type_move_assignment)
{
    saam::var<std::string> text("Hello world");
    std::string text2("Hello");
    text = std::move(text2);
...
TEST(counted_var_test, var_underlying_type_emplacement)
{
    saam::var<std::string> text("Hello world");
    text.emplace("Hello");
...
TEST(counted_var_test, var_copy_assignment)
{
    saam::var<std::string> text("Hello world");
...
TEST(counted_var_test, var_access_with_mutable_content)
{
    saam::var<std::string> text("Hello world");
...
TEST(counted_var_test, var_access_with_immutable_content)
{
