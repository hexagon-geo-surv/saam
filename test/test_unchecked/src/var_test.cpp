...
TEST(unchecked_var_test, var_underlying_type_copy_creation)
{
...
TEST(unchecked_var_test, var_underlying_type_move_creation)
{
    std::string text("Hello world");
...
TEST(unchecked_var_test, var_underlying_type_copy_assignment)
{
...
TEST(unchecked_var_test, var_underlying_type_move_assignment)
{
    saam::var<std::string> text("Hello world");
    std::string text2("Hello");
    text = std::move(text2);
...
TEST(unchecked_var_test, var_underlying_type_emplacement)
{
    saam::var<std::string> text("Hello world");
    text.emplace("Hello");
...
TEST(unchecked_var_test, compare_var_with_underlying_type)
{
    saam::var<std::string> text("Hello world");
...
TEST(unchecked_var_test, var_copy_assignment)
{
    saam::var<std::string> text("Hello world");
...
TEST(unchecked_var_test, var_move_assignment)
{
    saam::var<std::string> text("Hello world");
    saam::var<std::string> text2("Welcome");
    text2 = std::move(text);
