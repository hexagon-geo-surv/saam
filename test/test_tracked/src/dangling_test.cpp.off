...
class tracked_dangling_test : public ::testing::Test
{
  public:
    void SetUp() override
    {
...
TEST_F(tracked_dangling_test, return_dangling_reference)
{
...
TEST_F(tracked_dangling_test, return_dangling_const_reference)
{
...
TEST_F(tracked_dangling_test, free_variable_before_ref)
{
    {
...
TEST_F(tracked_dangling_test, return_dangling_reference_with_return_value_optimization)
{
    {
        saam::var<std::string> text{std::in_place, "hello"};
...
TEST_F(tracked_dangling_test, container_invalidates_reference)
{
